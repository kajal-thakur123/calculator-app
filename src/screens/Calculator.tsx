...
const Calculator = () => {
  ...
  const resetButtonClassName =
    parseFloat(calculateTipAmount()) === parseFloat("0") &&
    parseFloat(calculateTotalAmountPerPerson()) === parseFloat("0")
      ? "resetButton"
            ...
            <div className="bill">
              ...
              <div className="billInput">
                <input
                  type="text"
                  placeholder="0"
                  className={`billAmountInput ${
                    billAmount === 0 ? "zero" : "non-zero"
                  }`}
                  value={billAmount}
                ...
                {showCustomInput && (
                  <div className="custom-tip-input">
                    <input
                      ...
                      placeholder="0%"
                      className={`billAmountInput ${
                        customTipPercentage === 0 ? "zero" : "non-zero"
                      }`}
            ...
            <div className="users">
              ...
              <div className="billInput">
                <input
                  ...
                  placeholder="0"
                  className={`billAmountInput ${
                    numberOfPeople === 0 ? "zero" : "non-zero"
                  }`}
          ...
          <div className="second">
            <div className="total">
              <div className="heading">
                ...
                <div className="price">
                  ${parseFloat(calculateTipAmount()).toFixed(2)}
                </div>
              </div>
              <div className="heading">
                <div>
